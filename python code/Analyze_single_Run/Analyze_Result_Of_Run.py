...
'''
def analyze_func(f_name,f124_vals):
	f2 = 0.75
	dict_of_res =  {}
	with open('{}'.format(f_name), 'r') as f:
	...
	nextStep = firstT
	headers_csv = '' '{}'.format(f_name), 'r'
	with open('species{}_{}_0_{}.txt'.format(f11, f12,f14), 'r') as file:
		...
		with open('CSV_single_Res/species{}_{}_0_{}.csv'.format(f11, f12,f14),'a') as csv_file:
...
if __name__ == "__main__":
	analyze_func('species50_100_0_150.txt',(50,100,150))
