...
def main():
    ...
    for f11 in f1_vals:
        for f12 in f1_vals:
            for f13 in f1_vals:
                for f14 in f1_vals:
                    print ('------------------------------ f11, f12, f13, f14:', f11, f12, f13, f14)
                    ...
                    mult.append(f13)
                    mult.append(f14)
                    for line_num, (line, mult) in enumerate(zip(lines[14:], mult)):
                        data = line.split()
                        data[2] = str(f11)#mult[line_num])
                        data[3] = str(f2_vals)
                        ...
                        if re.match(r"([0-9]+)", line):
                            ...
                            if temp:
                                if int(temp.group(1)) == 152000:
                                    dict = {"f11":f11,"f12":f12,"f13":f13,"f14":f14,"C11H18N2": 0, "C19H20O4": 0, "C30H38O4N2": 0, "C41H56O4N4": 0, "C49H58O8N2": 0, "C68H78O12N2": 0,"C79H96O12N4": 0, "Other": 0}
                    ...
                    str_forces = "f1 = "+ str(f11)+"_"+ str(f12)+ "_"+str(f13)+ "_"+str(f14)+ " f2 = " + str(f2_vals) + "\n"
